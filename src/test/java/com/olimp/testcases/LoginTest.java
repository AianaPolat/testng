...
import com.olimp.utils.ConfigsReader;
...
public class LoginTest extends CommonMethods{
	...
	{
		//this is where the onTestStart method will execute!!!
		...
		test.info("Verifying that the user logged in successfully!");
		...
		//the line above will trigger one of the listener methods: onTestSuccess, onTestFailure
			//we denote the test status
			//we attach a screenshot to the report
